...
**Описание проекта:**
*Smart Car Costs* — это веб-приложение для учета и анализа расходов на автомобиль. Пользователь может фиксировать все затраты, связанные с владением автомобилем (топливо, страховка, ремонт, техническое обслуживание и др.), а также отслеживать их изменение во времени.
...
Пользователь может указать даты окончания страховки и технического обслуживания. Система автоматически отслеживает приближение этих дат и отправляет уведомления заранее (За месяц, за 7 дней и за днеь), что позволяет избежать просрочек и дополнительных расходов.
