...
## Goal of Sprint
Update "test interface" into modern one, create other page to continue development, start to implement JWY authentication, 
start to create Service role, implement filters by dates and categories of expenses
